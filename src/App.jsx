    ...
    return (
        <div className='grid place-items-center min-h-screen bg-gray-900'>
            <div className='bg-purple-950 sm:max-w-md sm:text-xl rounded-lg p-2 text-white grid place-items-center gap-4'>
                ...
                {gameStarted ? <Game gameTopic={gameTopic} setGameStarted={setGameStarted} gameMode={gameMode}/> : <Tutorial setGameTopic={setGameTopic} startGame={startGame} setGameMode={setGameMode}/>}
            </div>
        </div>
    )
}
